		...
		<div id="sq-bottom-footer">
			<div class="sq-container sq-clearfix">
				<div class="sq-site-info">
					<?php printf( esc_html__( 'Copyright © 2012–2016. Midwest CAD Solutions. All rights reserved.', 'square' ) ); ?>
					<span class="sep"> | </span>
					<?php echo "<a href='http://mcscad.com/kimai093/' rel='login' target='_blank'>Login</a>" ?>
				</div>
